...
app.get("/urls", (req, res) => {
  ...
  if (req.cookies.user_id) {
    templateVars.urls = findRegisteredURL(req.cookies.user_id);
...
app.post("/urls", (req, res) => {
  ...
  urlDatabase[shortUrl] = { longURL: recievedLongUrl, userID: req.cookies.user_id }
  res.redirect("/urls")
...
app.get("/urls/:shortURL", (req, res) => {
  if (req.cookies.user_id) {
    if (getShortURL(req.cookies.user_id).indexOf(req.params.shortURL) !== -1) {
